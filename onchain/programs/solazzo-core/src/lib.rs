...
// Canonical Solazzo program ID. This MUST stay in sync with:
//   - onchain/Anchor.toml [programs.localnet] solazzo_core
//   - make/src/lib/onchain/idl/solazzo_core.json "address"
//   - onchain/target/idl/solazzo_core.json "address" (regenerated by anchor build)
// A repo-level test (make/src/lib/__tests__/program-id.test.ts) asserts equality.
