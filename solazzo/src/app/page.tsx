 ...
 * ================================================================
 *
 * TEST 1: Sticky CTA vs No Sticky CTA
 * - Hypothesis: A persistent floating CTA in the bottom-right captures
 *   mid-scroll intent from the ~90% of the page with zero CTAs.
 * - Metric: CTR to make.solazzo.fun (primary), scroll depth at first click.
 * - Expected: +15-25% overall CTR lift, mostly from 40-70% scroll depth.
 * - Toggle: remove <ScrollEffects /> or ?sticky=0 query param.
 *
 * TEST 2: "How It Works" Summary vs Straight Into Abstract
 * - Hypothesis: Twitter/Discord visitors need a quick mental model before
 *   committing to a long whitepaper read.
 * - Metric: Scroll depth past section 3 (primary), CTA clicks (secondary).
 * - Expected: +10-15% scroll depth improvement.
 * - Toggle: remove #how-it-works section.
 *
 * TEST 3: Hero CTA Copy Variants
 * - Variants:
 *   A (current):  "See yourself in oil →"
 *   B:            "Create Your Portrait — Free →"
 *   C:            "Claim your portrait →"
 * - Metric: Hero CTA click-through rate.
 * - Expected: Variant A wins on desire/curiosity. B wins on clarity.
 *
 * ================================================================
 */
...
export default function Home() {
  return (
    <main className="max-w-[640px] mx-auto px-6 py-20 sm:py-32">
        ...
        {/* A/B Variant A (current — identity-led):
            "One thousand believers. One thousand portraits."
            CTA: "See yourself in oil →" */}

        {/* A/B Variant B (conviction-led):
            "A portrait you have to earn."
            CTA: "Enter the studio →" */}

        {/* A/B Variant C (scarcity + status):
            "1,000 slots. 1,000 believers. No one else."
            CTA: "Claim your portrait →" */}

        <div className="mb-24 sm:mb-36">
          <p className="font-serif-display text-3xl sm:text-4xl font-normal leading-snug text-foreground mb-8">
            One thousand believers. One thousand portraits.
          </p>
          <p className="text-base text-muted leading-relaxed">
            Lock SOL into a slot. Receive a Baroque oil portrait of your own
            face &mdash; one that evolves as SOL climbs toward $1,000. Your
            capital comes back. The only thing you can lose is your position.
          </p>
        ...
        {/* ---------------------------------------------------------- */}
        {/* HOW IT WORKS — quick summary for scanners                  */}
        {/* ---------------------------------------------------------- */}
        <div id="how-it-works" className="scroll-reveal mb-20 border border-muted/15 p-6 sm:p-8">
          <p className="text-xs uppercase tracking-widest text-muted/60 mb-5">How it works</p>
          <ol className="text-sm text-foreground/70 leading-relaxed space-y-3 list-none pl-0">
            <li className="flex gap-3">
              ...
              <span><strong className="text-foreground">Lock SOL</strong> into any of 1,000 numbered slots. No mint price &mdash; you commit capital, not spend it.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-foreground/30 font-medium shrink-0">02</span>
              <span><strong className="text-foreground">Get your portrait</strong> &mdash; an AI-generated Baroque oil painting of your own face, evolving across five stages as SOL climbs toward $1,000.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-foreground/30 font-medium shrink-0">03</span>
              <span><strong className="text-foreground">Defend or be displaced</strong> &mdash; anyone can outbid your slot. The displaced owner gets their locked SOL back.</span>
            </li>
            <li className="flex gap-3">
              <span className="text-foreground/30 font-medium shrink-0">04</span>
              <span><strong className="text-foreground">Settlement</strong> &mdash; when SOL hits $1,000 (or Mar 2030), all principal is returned. You get your SOL back at whatever it&rsquo;s then worth.</span>
            </li>
          </ol>
        </div>

        {/* Client island: progress bar + sticky CTA (sentinel here) */}
        <ScrollEffects />
