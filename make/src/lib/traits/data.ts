...
export const PALETTE_DIRECTIVES: PaletteDirectives = {
  1: "Palette stays muted and grave — umber, burnt sienna, deep oxblood warmth in the light, and near-black shadows. No brightness boost, no vibrancy. The color of patience and quiet endurance.",
  2: "Palette warms slightly — burnt sienna deepens to amber, shadows retain depth but light areas introduce touches of ochre and warm gold. The first suggestion that things are improving. Still restrained, never celebratory.",
  3: "Palette enriches noticeably — warm golds, deep burgundy, rich amber dominate the lit areas. Shadows remain deep but carry warmth rather than void. The color of established comfort, of rooms with good lighting.",
  4: "Palette hits maximum saturation — vivid golds, electric highlights, occasional cool-toned reflections from diamonds and metal. Shadows may carry color (deep purple, midnight blue). The color of excess, of flash photography at 3am, of too much of everything.",
  5: "Palette returns to restraint but with sophistication — muted warm greys, soft platinum light, desaturated gold that reads as memory rather than presence. Shadows are softer, less absolute. The color of dawn after a long night, of things settling.",
};
...
export const PROP: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "crumpled-paper-bag", name: "Crumpled paper bag", stages: [1], weight: 6, rarity: "Uncommon", fragment: "A crumpled brown paper bag is held against the chest, its creased surface catching light on every fold.", tags: ["held-object"] },
    ...
    { id: "coffee-cup", name: "Coffee cup (paper)", stages: [2], weight: 10, rarity: "Common", fragment: "A paper coffee cup is held casually in one hand, its cardboard sleeve catching warm light, steam suggested by a soft haze.", tags: ["held-object"] },
    ...
    { id: "champagne-flute", name: "Champagne flute", stages: [3], weight: 12, rarity: "Common", fragment: "A champagne flute is held by its stem, bubbles rising in the golden liquid, the glass catching and refracting light.", tags: ["held-object"] },
    ...
    { id: "cocktail-glass", name: "Cocktail glass", stages: [3], weight: 8, rarity: "Common", fragment: "A cocktail glass with an amber liquid catches warm light through its contents, the glass a vessel of golden transparency.", tags: ["held-object"] },
    ...
    { id: "wine-glass-red", name: "Wine glass (red)", stages: [3], weight: 7, rarity: "Common", fragment: "A glass of red wine is held by the bowl, the deep crimson liquid catching and transmitting warm light like a liquid ruby.", tags: ["held-object"] },
    // Stage IV
    { id: "nothing-iv", name: "Nothing", stages: [4], weight: 25, rarity: "Common", fragment: "", isNothing: true },
    { id: "dom-perignon", name: "Bottle of Dom Perignon", stages: [4], weight: 12, rarity: "Uncommon", fragment: "A bottle of Dom Perignon is held by the neck, its dark green glass and gold label catching dramatic light — celebration as still life.", tags: ["held-object"] },
    { id: "diamond-phone", name: "Diamond-studded phone", stages: [4], weight: 10, rarity: "Rare", fragment: "A diamond-studded phone is held in one hand, its encrusted case scattering points of light like a handheld disco ball.", tags: ["held-object"] },
    { id: "lit-sparkler", name: "Lit sparkler", stages: [4], weight: 8, rarity: "Uncommon", fragment: "A lit sparkler is held upward, its shower of white-hot sparks painted as individual streaks of light against the dark.", tags: ["held-object"] },
    ...
    { id: "sword", name: "A sword", stages: [4], weight: 5, rarity: "Legendary", fragment: "A sword is held upright, its polished blade catching a long streak of dramatic light — anachronistic and utterly serious.", tags: ["held-object"] },
    ...
    { id: "flaming-torch", name: "Flaming torch", stages: [4], weight: 4, rarity: "Legendary", fragment: "A flaming torch is held upward, its fire painted with thick orange and yellow impasto, casting warm flickering light across the subject's face.", tags: ["held-object"] },
    // Stage V
    { id: "nothing-v", name: "Nothing", stages: [5], weight: 40, rarity: "Common", fragment: "", isNothing: true },
    { id: "cup-of-tea", name: "Single cup of tea", stages: [5], weight: 15, rarity: "Common", fragment: "A cup of tea is held in both hands, steam rising softly, the porcelain catching gentle diffused light — a moment of stillness.", tags: ["held-object"] },
...
export const CLOTHING: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "headphones-neck", name: "Headphones around neck (Beats)", stages: [4], weight: 12, rarity: "Uncommon", fragment: "Beats headphones hang around the neck, their polished cups catching reflected light — modern technology as jewelry." },
