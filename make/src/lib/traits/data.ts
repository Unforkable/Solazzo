...
export const PROP: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "new-1775743342972", name: "Shiba Inu", stages: [1, 2, 3, 5], weight: 6, rarity: "Common", fragment: "A Shiba Inu sits cradled in the crook of one arm, its rust-and-cream coat rendered in short, precise brushstrokes. The dog's expression is unimpressed. Both subject and animal hold the same self-possession." },
    // Stage II
