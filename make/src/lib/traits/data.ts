...
export const PROP: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "new-1778596605028", name: "Rooster", stages: [3, 4], weight: 3, rarity: "Legendary", fragment: "A large rooster is held against the subject's chest with both arms, its feathers painted with the full attention the Baroque gives to velvet and fur. The bird is calm. The subject does not explain it." },
    // Stage IV
