...
export const WRIST: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "candy-bracelet", name: "Candy bracelet", stages: [1], weight: 5, rarity: "Rare", fragment: "A candy bracelet circles the wrist, its small sugar discs catching tiny points of warm light on each chalky bead — edible jewelry rendered in oil with the same care as diamonds, several beads already eaten." },
    { id: "snap-bracelet", name: "Snap bracelet", stages: [1], weight: 8, rarity: "Uncommon", fragment: "A snap bracelet is coiled around the wrist, its metallic spine catching a thin arc of warm light — a child's toy worn without irony, its satisfying geometry painted with complete seriousness." },
    { id: "festival-wristbands", name: "Festival wristbands (stacked)", stages: [1], weight: 12, rarity: "Common", fragment: "A stack of paper and fabric festival wristbands circles the wrist, each one a different color and texture — accumulated experiences rendered as a small archive of nights that mattered, the oldest ones faded almost to nothing." },
    { id: "red-string-kabbalah", name: "Red string (Kabbalah)", stages: [1, 2], weight: 8, rarity: "Uncommon", fragment: "A thin red string is tied at the wrist, its simple knot catching a point of warm light — a talisman reduced to its minimum form, the red thread barely visible against dark skin and darker shadow." },
    { id: "dental-floss-wrist-tie", name: "Dental floss wrist tie", stages: [1], weight: 3, rarity: "Legendary", fragment: "A loop of white dental floss is tied around the wrist, its waxy thread catching the faintest line of cool light — the cheapest possible adornment, painted with the same gravity as a Cartier cuff." },
    // Stage II
    ...
    { id: "scrunchie-on-wrist", name: "Scrunchie on wrist", stages: [2], weight: 12, rarity: "Common", fragment: "A fabric scrunchie sits on the wrist, its gathered cloth catching soft diffused light on every fold — worn there for convenience or kept there for sentiment, the distinction unresolvable." },
    { id: "paracord-bracelet", name: "Paracord bracelet", stages: [2], weight: 12, rarity: "Common", fragment: "A paracord bracelet in a tight weave circles the wrist, its synthetic cord catching flat directional light on the raised pattern — utilitarian craft worn as identity, the clasp a small point of hard light." },
    { id: "sweatband-tennis", name: "Sweatband (tennis)", stages: [2], weight: 8, rarity: "Uncommon", fragment: "A white terry cloth sweatband sits thick on the wrist, its looped fabric catching soft warm light on every raised fibre — athletic utility rendered as an object of quiet dignity." },
    { id: "woven-friendship-bracelet", name: "Woven friendship bracelet (intentional)", stages: [2], weight: 8, rarity: "Uncommon", fragment: "A tightly woven friendship bracelet in deliberate colors circles the wrist — not frayed like its Stage I counterpart, but kept, maintained, chosen again every morning. The thread catches warm light on its raised pattern." },
    { id: "thin-rope-bracelet-charm", name: "Thin rope bracelet with charm", stages: [2], weight: 12, rarity: "Common", fragment: "A thin waxed rope bracelet circles the wrist, a small metal charm hanging from its knot — the charm catching a single point of warm light, the rope itself disappearing into shadow." },
    { id: "moonswatch", name: "MoonSwatch", stages: [2], weight: 8, rarity: "Common", fragment: "A MoonSwatch sits on the wrist, its bioceramic case and Mission patch dial rendered in soft matte tones that absorb rather than catch light. A collaboration pressed into plastic, worn completely seriously." },
    { id: "swatch-x-ap-royal-pop", name: "Swatch x AP Royal Pop", stages: [2, 3], weight: 10, rarity: "Common", fragment: "A Swatch Royal Pop sits on the wrist, its octagonal bezel faithfully reproduced in lightweight plastic — the Royal Oak's silhouette at a fraction of the weight, catching light the same way but giving nothing back. Worn without irony." },
    // Stage III
    ...
    { id: "tibetan-prayer-beads", name: "Tibetan prayer beads", stages: [3], weight: 8, rarity: "Uncommon", fragment: "A strand of Tibetan prayer beads wraps twice around the wrist, each dark wooden bead catching a small sphere of warm light — worn alongside the luxury watch, the two objects in quiet conversation." },
    { id: "leather-wrap-designer", name: "Leather wrap bracelet (designer)", stages: [3], weight: 12, rarity: "Common", fragment: "A leather wrap bracelet circles the wrist multiple times, its quality hide catching warm light on every turn — the brass clasp a small hard point of gold light, leather darkened by wear." },
    { id: "enamel-bangle-bold", name: "Enamel bangle (bold color)", stages: [3], weight: 8, rarity: "Uncommon", fragment: "A bold enamel bangle sits solid on the wrist, its lacquered surface catching warm light in a flat vivid plane of color — a single object that refuses to be subtle, painted as a small sun against the dark canvas." },
    { id: "piaget-altiplano", name: "Piaget Altiplano", stages: [3], weight: 6, rarity: "Rare", fragment: "A Piaget Altiplano sits on the wrist, its case so thin it barely interrupts the skin beneath — the gold edge catching a single whisper of warm light, the dial a study in deliberate emptiness." },
    { id: "audemars-piguet-royal-oak", name: "Audemars Piguet Royal Oak", stages: [3, 5], weight: 5, rarity: "Rare", fragment: "An Audemars Piguet Royal Oak sits on the wrist, its octagonal bezel and integrated bracelet unmistakable — brushed and polished steel alternating in the directional light, the tapisserie dial a grid of tiny shadows. No diamonds. " },
    { id: "cartier-crash", name: "Cartier Crash", stages: [3, 4, 5], weight: 2, rarity: "Legendary", fragment: "A Cartier Crash sits on the wrist, its warped asymmetric case defying every convention of watchmaking — the melted oval form catching light unevenly, each distorted edge a different temperature of gold." },
    { id: "van-cleef-arpels-alhambra-bracelet", name: "Van Cleef & Arpels Alhambra bracelet", stages: [3, 4], weight: 5, rarity: "Rare", fragment: " A Van Cleef & Arpels Alhambra bracelet circles the wrist, its row of clover motifs set in gold, each one a small medallion catching warm light at the center. Delicate for this wrist. Intentionally so.\n" },
    { id: "patek-philippe-nautilus", name: "Patek Philippe Nautilus", stages: [3, 4], weight: 5, rarity: "Uncommon", fragment: "A Patek Philippe Nautilus sits on the wrist, its porthole bezel and horizontally embossed dial immediately legible to anyone who knows. The integrated bracelet catches light across every alternating brushed and polished link." },
    // Stage IV
    ...
    { id: "diamond-tennis-bracelet", name: "Diamond tennis bracelet", stages: [4], weight: 5, rarity: "Rare", fragment: "A diamond tennis bracelet encircles the wrist, its continuous line of stones catching individual points of cold fire — each diamond rendered separately, the whole thing a constellation of refracted light worn casually." },
    { id: "hermes-clic-clac", name: "Hermès enamel clic clac", stages: [4], weight: 8, rarity: "Uncommon", fragment: "An Hermès enamel clic clac bracelet snaps around the wrist, its wide band of lacquered color catching warm light on its flat surface — the iconic H hardware at the clasp a small gold interruption." },
    { id: "piaget-polo", name: "Piaget Polo (vintage)", stages: [4], weight: 6, rarity: "Rare", fragment: "A vintage Piaget Polo sits on the wrist, its integrated bracelet catching light link by link — the case and bracelet a single flowing object, understated against the excess surrounding it." },
    // Stage V
    ...
    { id: "piaget-emperador", name: "Piaget Emperador (vintage)", stages: [5], weight: 6, rarity: "Rare", fragment: "A vintage Piaget Emperador rests quietly on the wrist, its cushion case a departure from conventional geometry — the gold catching only the softest warm light, the dial barely visible, the watch announcing nothing to anyone who isn't already looking." },
  ],
};
...
export const CHAINS: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "safety-pin-chain", name: "Safety pin chain", stages: [1], weight: 8, rarity: "Uncommon", fragment: "A large safety pin hangs from a thin tarnished chain at the throat, its simple steel form catching a clean line of cool light against dark fabric — punk reduced to a single object, worn without explanation." },
    { id: "angel-wing-charm", name: "Angel wing charm", stages: [1, 2], weight: 8, rarity: "Common", fragment: "A small angel wing charm hangs from a thin cheap chain, its ridged surface catching light along each feather detail — devotional or decorative, the distinction irrelevant, the metal already starting to tarnish." },
    { id: "crucifix-small", name: "Crucifix (small, tarnished)", stages: [1], weight: 10, rarity: "Common", fragment: "A small tarnished crucifix hangs from a thin chain at the throat, its oxidised surface catching only the faintest warm light — religious iconography worn as inheritance, not statement." },
    { id: "butterfly-pendant-cheap", name: "Butterfly pendant", stages: [1, 2], weight: 8, rarity: "Uncommon", fragment: "A small enamel butterfly pendant hangs from a thin chain at the collarbone, its painted wings catching a point of warm light — cheap but chosen, worn with complete conviction." },
    { id: "four-leaf-clover-small", name: "Four-leaf clover pendant", stages: [1, 2], weight: 8, rarity: "Uncommon", fragment: "A small four-leaf clover pendant hangs from a thin chain at the chest, its enamel surface catching warm light — a quiet talisman worn close to the skin, its material modest, its meaning private." },
    { id: "breakpoint-lanyard", name: "Breakpoint lanyard", stages: [1, 2], weight: 8, rarity: "Uncommon", fragment: "A conference lanyard hangs around the neck, its printed fabric strap resting against the chest, the badge face-down at sternum height. The kind of thing you forget to take off. Rendered with the same weight as a gold chain." },
    // Stage II
    ...
    { id: "flip-phone-pendant", name: "Tiny flip phone pendant", stages: [2, 3], weight: 5, rarity: "Rare", fragment: "A miniature flip phone charm hangs from a clean gold-fill chain at the chest, the pendant catching warm light on its small sculpted surface — a phone worn as jewelry on a chain that actually costs something, its function irrelevant, its presence total." },
    // Stage III
    ...
    { id: "padlock-pendant", name: "Padlock pendant", stages: [3, 4], weight: 5, rarity: "Uncommon", fragment: "A small brass padlock hangs closed from a heavy gold chain at the chest, its body catching a hard concentrated point of light — worn locked, key unknown, meaning private." },
    { id: "four-leaf-clover-gold", name: "Four-leaf clover pendant (gold)", stages: [3, 4], weight: 6, rarity: "Uncommon", fragment: "A solid gold four-leaf clover pendant hangs from a rope chain at the chest, each leaf catching warm directional light individually — luck worn as luxury, talisman upgraded but intention unchanged." },
    { id: "crucifix-gold", name: "Crucifix (gold, oversized)", stages: [3, 4], weight: 10, rarity: "Common", fragment: "An oversized gold crucifix hangs heavy from a thick chain at the chest, its surface catching multiple points of warm directional light — religious iconography worn as cultural inheritance, the gold undeniable." },
    // Stage IV
    ...
    { id: "butterfly-pendant-gold", name: "Butterfly pendant (gold)", stages: [5], weight: 6, rarity: "Rare", fragment: "A delicate gold butterfly pendant rests at the collarbone on a thin chain, its spread wings catching warm light on each lobe — small, precise, the kind of thing kept for years, painted with the care of a still life." },
  ],
};
...
export const GRILLZ: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "fanged-diamond-grillz", name: "Fanged diamond grillz", stages: [4], weight: 6, rarity: "Rare", fragment: "Diamond grillz with extended fanged canines catch light in sharp points, the exaggerated teeth transforming the smile into something predatory and theatrical." },
...
export const EYEWEAR: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "celine-designer-glasses", name: "Celine Designer Glasses", stages: [2, 3], weight: 10, rarity: "Uncommon", fragment: "Female Celine frames sit on the face, their oversized rectangular shape casting a faint shadow across the cheekbones — the frames themselves the statement, no lens shine needed." },
    { id: "kanye-west-shutter-shades", name: "Kanye West shutter shades", stages: [2, 3, 4], weight: 2, rarity: "Legendary", fragment: "Horizontal slit shutter shades sit on the face — their plastic slats catching parallel lines of light, the eyes behind them invisible, the absurdity worn with complete conviction." },
    { id: "kurt-cobain-glasses", name: "Kurt Cobain glasses", stages: [2, 3, 4], weight: 5, rarity: "Rare", fragment: "Small oval tinted glasses sit low on the nose, their thin wire frames barely catching light — the lenses a pale wash of color against the dark composition." },
    { id: "micro-oval-lenses", name: "Tiny oval micro lenses", stages: [2, 3], weight: 8, rarity: "Uncommon", fragment: "Small oval lenses sit low on the nose, their tiny tinted circles barely covering the eyes — thin wire frames catching a single hair-thin line of light, the eyes visible above the lenses, the glasses more symbol than function." },
    { id: "narrow-rectangular", name: "Narrow rectangular shades", stages: [2, 3], weight: 8, rarity: "Uncommon", fragment: "Narrow rectangular lenses in thin metal frames sit across the nose, their early-2000s proportions deliberately small — the tinted glass catching a flat plane of warm light, the frames almost invisible against the face." },
    { id: "heart-shaped-shades", name: "Heart shaped sunglasses", stages: [2, 3, 4], weight: 5, rarity: "Rare", fragment: "Heart-shaped lenses in pink or red tint sit on the face, each lobe of the heart catching warm light differently — absurd, deliberate, worn with the conviction of someone who has never second-guessed anything." },
    { id: "oakley-sport-shades", name: "Oakley sport shades", stages: [2, 3], weight: 8, rarity: "Uncommon", fragment: "Wraparound Oakley sport sunglasses sit on the face, their curved polycarbonate lenses catching a dramatic sweep of reflected light along the shield — athletic eyewear worn nowhere near a sport, the rubber nose grip painted with the same care as fine metalwork." },
    // Stage III
    { id: "oversized-wraparound-y2k", name: "Oversized wraparound (Y2K)", stages: [3, 4], weight: 8, rarity: "Uncommon", fragment: "Oversized wraparound lenses curve around the face in a single continuous shield of tinted plastic, their Y2K proportions dominating the upper half of the composition — the surface catching a long unbroken arc of reflected warm light." },
    ...
    { id: "miu-miu-yellow-tint-vintage-glasses", name: "Miu Miu yellow tint vintage glasses", stages: [3, 4, 5], weight: 5, rarity: "Rare", fragment: "Vintage oval frames with yellow-tinted lenses sit on the face, the tint casting a warm amber glow across the eyes — the frames delicate, their gold wire catching a single thin highlight." },
    // Stage IV
    ...
    { id: "ski-goggles-forehead", name: "Ski goggles on forehead", stages: [4], weight: 10, rarity: "Legendary", fragment: "Ski goggles pushed up on the forehead, their mirrored orange lens reflecting an Solana Logo  — displacement rendered sincerely.", tags: ["opaque-eyewear"] },
...
export const PROP: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "white-rabbit", name: "White rabbit", stages: [1, 2], weight: 4, rarity: "Rare", fragment: "A white rabbit is held against the chest with both hands, its fur rendered strand by strand in oil — the animal calm, its pink eyes catching a point of warm light, the whole arrangement suggesting a magic trick that hasn't happened yet.", tags: ["held-object", "animal-prop"] },
    { id: "hedgehog", name: "Hedgehog", stages: [1, 2], weight: 4, rarity: "Rare", fragment: "A hedgehog sits in the cupped palms, its spines catching individual points of light like a small crown of thorns — the animal unbothered, the subject unbothered, the situation unexplained.", tags: ["held-object", "animal-prop"] },
    { id: "pigeon", name: "Pigeon", stages: [1], weight: 5, rarity: "Uncommon", fragment: "A street pigeon sits in the cupped hands, its iridescent neck feathers catching shifting points of warm light — the most common bird in the world painted with the gravity of a rare specimen.", tags: ["held-object", "animal-prop"] },
    { id: "pepe-plushie", name: "Pepe the frog plushie", stages: [1, 2], weight: 4, rarity: "Rare", fragment: "A Pepe the frog plush toy is held against the chest, its green fabric catching warm light on the rounded surfaces — internet folklore rendered as stuffed animal, painted with absolute sincerity.", tags: ["held-object"] },
    { id: "chicken-nugget", name: "Single chicken nugget", stages: [1], weight: 3, rarity: "Legendary", fragment: "A single chicken nugget is held between thumb and forefinger, its breaded surface catching warm light on every irregular facet — fast food rendered as precious object, painted with the reverence of a Dutch still life grape.", tags: ["held-object"] },
    { id: "instant-ramen-cup", name: "Cup of instant ramen", stages: [1], weight: 5, rarity: "Uncommon", fragment: "A styrofoam cup of instant ramen is held in both hands, steam rising softly where the warm light catches it — the cup's printed graphics barely legible, the steam the brightest element in the composition.", tags: ["held-object"] },
    { id: "laser-eyes-printout", name: "Laser eyes printout", stages: [1], weight: 3, rarity: "Legendary", fragment: "A printed sheet of paper is held up showing a face with laser eyes — the printout slightly crumpled, the red laser beams catching flat warm light on the paper surface, the joke rendered in oil with complete conviction.", tags: ["held-object"] },
    { id: "flamin-hot-cheetos", name: "Bag of Flamin' Hot Cheetos", stages: [1, 2], weight: 5, rarity: "Uncommon", fragment: "A bag of Flamin' Hot Cheetos is gripped in one hand, its bright red packaging a jarring burst of color against the dark canvas — junk food rendered in oil with the gravity of a still life pomegranate.", tags: ["held-object"] },
    { id: "shiba-inu", name: "Shiba Inu", stages: [1, 2, 3, 5], weight: 6, rarity: "Common", fragment: "A Shiba Inu sits cradled in the crook of one arm, its rust-and-cream coat rendered in short, precise brushstrokes. The dog's expression is unimpressed. Both subject and animal hold the same self-possession." },
    { id: "typewriter", name: "Typewriter", stages: [1, 5], weight: 6, rarity: "Uncommon", fragment: "An old typewriter sits facing the subject, keys toward them, a half-typed page still loaded. The hands are withdrawn. The machine waits in the same soft light as everything else — present, unhurried, unfinished." },
    // Stage II
    ...
    { id: "crow", name: "Crow", stages: [2, 3], weight: 4, rarity: "Rare", fragment: "A crow perches on one forearm, its black feathers absorbing almost all light — only the sharp edge of its beak and one glossy eye catching warm light against the dark void, the bird and the background nearly indistinguishable.", tags: ["held-object", "animal-prop"] },
    { id: "black-cat", name: "Black cat", stages: [2, 3], weight: 5, rarity: "Uncommon", fragment: "A black cat is held against the chest, its dark fur absorbing almost all light — only its eyes catching two points of green-gold reflection, the animal rendered as a shadow with intention.", tags: ["held-object", "animal-prop"] },
    { id: "magic-8-ball", name: "Magic 8-ball", stages: [2, 3], weight: 5, rarity: "Uncommon", fragment: "A Magic 8-ball is held in both hands, its black sphere catching a single dramatic point of warm light — the answer window facing the viewer, the response inside illegible, the question unasked.", tags: ["held-object"] },
    { id: "strawberry", name: "Single strawberry", stages: [2, 3], weight: 5, rarity: "Uncommon", fragment: "A single strawberry is held between two fingers, its red surface catching warm light on every seed dimple — the fruit painted with the precision of a botanical illustration, vivid against the surrounding darkness.", tags: ["held-object"] },
    // Stage III
    ...
    { id: "snake", name: "Snake", stages: [3, 4], weight: 4, rarity: "Rare", fragment: "A snake drapes across the forearms and hands, its scales catching directional light on every raised plate — the animal unhurried, its tongue a thin dark line, its weight implied by the way the arms hold slightly lower than they otherwise would.", tags: ["held-object", "animal-prop"] },
    { id: "iguana", name: "Iguana", stages: [3, 4], weight: 4, rarity: "Rare", fragment: "An iguana drapes across the shoulders and forearm, its scaled skin catching directional light on every ridge and plate — ancient, unbothered, rendered with the detail of a natural history illustration done in oil.", tags: ["held-object", "animal-prop"] },
    { id: "tiny-chihuahua", name: "Tiny chihuahua", stages: [3], weight: 5, rarity: "Uncommon", fragment: "A tiny chihuahua is cradled in one arm, its oversized ears catching warm light like two thin membranes — its eyes as alert and present as the subject's own, both of them looking at something outside the frame.", tags: ["held-object", "animal-prop"] },
    { id: "whole-pineapple", name: "Whole pineapple", stages: [3, 4], weight: 4, rarity: "Rare", fragment: "A whole pineapple is held at the base with both hands, its crown of spiky leaves catching individual points of light — tropical excess rendered as a Baroque trophy, the fruit's texture painted spike by spike.", tags: ["held-object"] },
    { id: "rooster", name: "Rooster", stages: [3, 4], weight: 3, rarity: "Legendary", fragment: "A large rooster is held against the subject's chest with both arms, its feathers painted with the full attention the Baroque gives to velvet and fur. The bird is calm. The subject does not explain it." },
    // Stage IV
    ...
    { id: "framed-screenshot", name: "Printed screenshot (framed)", stages: [4], weight: 4, rarity: "Rare", fragment: "A small framed screenshot is held up in one hand, its glass surface catching a flat rectangle of reflected light — the content of the screen indistinct, the act of framing it the entire statement.", tags: ["held-object"] },
    { id: "black-truffle", name: "Single black truffle", stages: [4, 5], weight: 4, rarity: "Rare", fragment: "A single black truffle is held in the palm, its rough dark surface catching warm light on every irregular bump — the most expensive fungus in the world rendered with the care of a jewel, its value invisible to anyone who doesn't already know.", tags: ["held-object"] },
    { id: "faberge-egg", name: "Fabergé egg", stages: [4], weight: 3, rarity: "Legendary", fragment: "A Fabergé egg is held in both hands, its jeweled surface catching multiple points of warm light simultaneously — each enamel panel and gold fitting rendered individually, an object so ornate it reads as absurd, painted as though it is not.", tags: ["held-object"] },
    { id: "caviar-tin", name: "Open caviar tin", stages: [4], weight: 4, rarity: "Rare", fragment: "An open tin of caviar is held in one hand, its dark pearls catching individual points of reflected light — the tin's label half-visible, the contents worth more than most monthly salaries, presented without ceremony.", tags: ["held-object"] },
    { id: "gold-bar", name: "Single gold bar", stages: [4], weight: 3, rarity: "Legendary", fragment: "A small gold bar is held flat on the open palm, its surface catching warm light in a single unbroken plane of gold — heavy, simple, the most literal possible statement of wealth rendered in oil.", tags: ["held-object"] },
    { id: "shiba-inu-in-branded-streetwear", name: "Shiba Inu (in branded streetwear)", stages: [4], weight: 5, rarity: "Rare", fragment: "A Shiba Inu sits propped against one forearm, wearing a miniature branded hoodie rendered with the same gravity as the subject's own clothing. The dog faces forward. Its expression registers nothing." },
    // Stage V
    ...
    { id: "koi-fish", name: "Koi fish (held)", stages: [5], weight: 3, rarity: "Legendary", fragment: "A large koi fish is held in both hands, its orange and white scales catching warm light on every surface — the water dripping from the hands painted as individual beads of light, the fish patient and enormous.", tags: ["held-object", "animal-prop"] },
...
export const CLOTHING: TraitCategoryDef = {
  ...
  items: [
    ...
    { id: "bootleg-rap-tee", name: "Bootleg rap tee", stages: [1], weight: 12, rarity: "Common", fragment: "A bootleg rap concert tee hangs loose on the shoulders, its faded iron-on graphic barely legible in the low light — the kind of shirt that was never officially licensed, rendered with the gravity of archival fabric." },
    { id: "japanese-streetwear-tee", name: "Japanese streetwear graphic tee", stages: [1, 2], weight: 8, rarity: "Uncommon", fragment: "An oversized tee with a dense Japanese graphic print covers the chest, the imagery — characters, patterns, abstract forms — visible where warm light falls across the fabric, the meaning absorbed into the cloth." },
    { id: "vintage-skate-tee", name: "Vintage skate tee (faded)", stages: [1], weight: 12, rarity: "Common", fragment: "A faded skate brand tee sits loose on the shoulders, its graphic worn to near-illegibility by washing — the remaining ink catching flat warm light on the chest, nostalgia rendered in cotton." },
    { id: "diy-painted-tee", name: "DIY painted tee", stages: [1], weight: 5, rarity: "Rare", fragment: "A plain tee with hand-painted imagery across the chest — brushwork visible, edges uneven, the paint cracked where the fabric folds — someone's art worn as clothing, rendered in oil with double sincerity." },
    { id: "thermal-undershirt-collar", name: "Thermal undershirt collar", stages: [1, 2], weight: 12, rarity: "Common", fragment: "A waffle-knit thermal undershirt peeks above the neckline of whatever sits on top, its ribbed collar catching warm light on every raised square of texture — the universal signal of dressing in layers because you have to." },
    // Stage II
    ...
    { id: "collared-shirt-under-crewneck", name: "Collared shirt under crewneck", stages: [2], weight: 12, rarity: "Common", fragment: "A collared shirt is worn beneath a crewneck, its pointed collar tips visible at the shoulders — the layered necklines catching light on both edges, a studied casualness." },
    { id: "zip-hoodie-open-over-tee", name: "Zip-up hoodie open over tee", stages: [2], weight: 12, rarity: "Common", fragment: "A zip-up hoodie hangs open over a t-shirt, the front panels falling to either side — the inner tee catching more light than the outer layer, the whole arrangement suggesting motion just stopped." },
    { id: "tracktop-collar", name: "Tracktop collar", stages: [2], weight: 12, rarity: "Common", fragment: "The collar of a tracktop frames the neck, its three-stripe or swoosh branding barely visible in the dramatic lighting — athletic heritage worn as identity, the zip pull catching a single point of light." },
    { id: "varsity-jacket-collar", name: "Varsity jacket collar", stages: [2, 3], weight: 8, rarity: "Uncommon", fragment: "A varsity jacket collar catches warm side-light on its wool body and leather sleeve edge — the ribbed collar a thick band of texture at the neck, the snap buttons catching individual points of light." },
    { id: "technical-puffer-collar", name: "Puffer jacket (technical)", stages: [2, 3], weight: 12, rarity: "Common", fragment: "A technical puffer jacket frames the shoulders, its quilted baffles catching directional light on every raised seam — functional warmth rendered as sculptural form, each channel of insulation a brushstroke." },
    { id: "coach-jacket-collar", name: "Coach jacket collar", stages: [2, 3], weight: 12, rarity: "Common", fragment: "A lightweight coach jacket collar sits at the neck, its nylon shell catching a clean surface sheen — the snap collar open, the lining visible at the edge, a flash of contrast colour in the shadow." },
    { id: "raw-edge-denim-collar", name: "Raw edge denim collar", stages: [2, 3], weight: 8, rarity: "Uncommon", fragment: "A raw-edge denim jacket collar frames the neck, its frayed edge catching light on every loose thread — the unfinished hem deliberate, the fraying controlled, wear as aesthetic choice." },
    // Stage III
    ...
    { id: "turtleneck-under-jacket", name: "Turtleneck under jacket", stages: [3], weight: 8, rarity: "Uncommon", fragment: "A fine knit turtleneck rises to the jaw beneath whatever jacket sits on top, its ribbed surface catching vertical lines of warm light — the layering deliberate, the proportions considered." },
    { id: "sukajan-collar", name: "Harajuku sukajan collar", stages: [3], weight: 5, rarity: "Rare", fragment: "The satin collar of a sukajan souvenir jacket catches light with a liquid sheen, its embroidered edge hinting at the imagery beneath — dragons or tigers suggested in the dark, the fabric luminous where the light finds it." },
    { id: "mesh-top-under-jacket", name: "Mesh top visible beneath jacket", stages: [3, 4], weight: 5, rarity: "Rare", fragment: "A mesh top is visible beneath an open jacket, its open weave catching light differently from the fabric surrounding it — skin visible through the grid, texture layered on texture." },
    // Stage IV
    ...
    { id: "sheer-organza-collar", name: "Sheer organza collar", stages: [4, 5], weight: 5, rarity: "Rare", fragment: "A sheer organza collar catches light with a gossamer quality — the fabric almost invisible, its presence revealed only by the way it refracts the warm light source into a soft halo at the neckline." },
    { id: "leather-harness-straps", name: "Leather harness straps", stages: [4], weight: 5, rarity: "Rare", fragment: "Leather harness straps cross the chest over whatever is worn beneath, their dark surface catching directional light on the raised edges — fashion as structure, structure as statement." },
    // Stage V
